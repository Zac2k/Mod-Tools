...
public static class NormalSolver
{
        ...
        public static void UnweldVertices(Mesh mesh)
    {
        ...
        Vector3[] flatShadedVertices = new Vector3[originalTriangles.Length];
        Vector3[] flatShadedNormals = new Vector3[originalTriangles.Length];
        ...
        for (int i = 0; i < originalTriangles.Length; i += 3)
        {
            ...
            // Assign the same normal for all three vertices of the face
            flatShadedNormals[i] = faceNormal;
            flatShadedNormals[i + 1] = faceNormal;
            flatShadedNormals[i + 2] = faceNormal;

            // Assign vertices
            flatShadedVertices[i] = vertex1;
            flatShadedVertices[i + 1] = vertex2;
            flatShadedVertices[i + 2] = vertex3;
        }

        mesh.vertices = flatShadedVertices;
        mesh.normals = flatShadedNormals;
        mesh.triangles = Enumerable.Range(0, flatShadedVertices.Length).ToArray();
    }
